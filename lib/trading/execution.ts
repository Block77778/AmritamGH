...
import { exchangeCredentials, executionOrders, tradingAuditLog } from '@/lib/db/schema'
import { decryptSecret } from './crypto'
import { cancelOrder, fetchQuote, placeLimitOrder } from './exchange-adapter'
...
export async function executeOpportunityCore(userId: string, input: {
